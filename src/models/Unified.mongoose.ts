...
export const schemaConnection = {
	...
	categories: { type: [ String ], enum: [ 'passthrough', 'hris', 'ats', 'auth', 'crm', 'enrich', 'martech', 'ticketing', 'uc', 'accounting', 'storage', 'commerce', 'payment', 'genai', 'messaging', 'kms', 'task', 'scim', 'lms', 'repo', 'metadata', 'calendar', 'verification', 'ads', 'forms', 'shipping', 'assessment', 'signing' ], index: true }, // The Integration categories that this connection supports
...
export const schemaIntegrationSupport = {
	...
	list_member_id: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] },
	virtual_webhook_member_id: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] },
	native_webhook_member_id: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] },
	list_content_id: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] },
	virtual_webhook_course_id: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] },
...
export const schemaWorkspaceIpAllowlistEntry = {
	ip_address: { type: String },
	name: { type: String },
...
export const schemaWorkspaceIntegration = {
	...
	categories: { type: [ String ], enum: [ 'passthrough', 'hris', 'ats', 'auth', 'crm', 'enrich', 'martech', 'ticketing', 'uc', 'accounting', 'storage', 'commerce', 'payment', 'genai', 'messaging', 'kms', 'task', 'scim', 'lms', 'repo', 'metadata', 'calendar', 'verification', 'ads', 'forms', 'shipping', 'assessment', 'signing' ] },

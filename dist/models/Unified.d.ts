...
export declare type TIssueType = typeof IssueType[number];
...
export declare type TSupportOutboundType = typeof SupportOutboundType[number];
export declare const WebhookDataType: readonly ["INITIAL-PARTIAL", "INITIAL-COMPLETE", "VIRTUAL", "NATIVE"];
export declare type TWebhookDataType = typeof WebhookDataType[number];
export declare const WebhookEvent: readonly ["updated", "created", "deleted"];
export declare type TWebhookEvent = typeof WebhookEvent[number];
...
export declare type TWorkspaceEventType = typeof WorkspaceEventType[number];

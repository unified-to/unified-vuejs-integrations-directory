...
export declare const IntegrationCategory: readonly ["passthrough", "hris", "ats", "auth", "crm", "enrich", "martech", "ticketing", "uc", "accounting", "storage", "commerce", "payment", "genai", "messaging", "kms", "task", "scim", "lms", "repo", "metadata", "calendar", "verification", "ads", "forms", "shipping", "assessment"];
...
export declare const WebhookDatabaseType: readonly ["mongodb", "mysql", "postgres", "mssql", "mariadb", "supabase"];
export declare type TWebhookDatabaseType = typeof WebhookDatabaseType[number];
...
export declare const CATEGORIES: ICategories[];
